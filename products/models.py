...
class CharacteristicsValue(models.Model):
    title = models.CharField(_('title'), max_length=100)
    characterstic = models.ForeignKey(Characteristic, verbose_name=_('characteristic'), on_delete=models.CASCADE)
...
class Instruction(models.Model):
    ...
    left_image = models.ForeignKey('common.Media', verbose_name=_('left image'), on_delete=models.CASCADE, related_name='instructions_left_image')
    right_image = models.ForeignKey('common.Media', verbose_name=_('right image'), on_delete=models.CASCADE, related_name='instructions_right_image')
