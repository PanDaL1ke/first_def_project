...
class Media(models.Model):
    ...
    file = models.FileField(upload_to='only_medias/', verbose_name=_('File'), validators=[FileExtensionValidator(allowed_extensions=['jpg', 'jpeg', 'png', 'mp4', 'avi', 'mov', 'mp3', 'doc', 'docx', 'xls', 'xlsx', 'ppt', 'pptx', 'txt', 'csv', 'zip', 'rar', 'webp', 'gif', 'wav'])])
